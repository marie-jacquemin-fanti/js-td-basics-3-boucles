...
let table = prompt("Donnez une table de multiplication : ");
let repeat = 0;

console.log(`Voici les 10 premières valeurs de la table de multiplication de la table de ${table} :`);

while (repeat <= 10){
    repeat++
    console.log(table * repeat);
}
